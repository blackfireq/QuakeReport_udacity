...
//                  Add earthquake to list of earthquakes
                earthquakes.add(new Earthquake(mag,place,timeInMilliseconds,webURL));
            }
